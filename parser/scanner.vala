...
enum Token {
    ...
    HASH, LEFT_PAREN, PIPE, RIGHT_PAREN, PERIOD, QUESTION_MARK, SEMICOLON, LESS_THAN, GREATER_THAN,

    // keywords
    ABSTRACT, ASYNC, BASE, CLASS, CONST, CONSTRUCT, CONSTRUCTOR, DEF, DELEGATE, ELSE, ENUM, EXTENDS,
    EXTERN, EXTERNAL, FOR, FOREACH, IF, INLINE, INTERFACE, INTERNAL, NAMESPACE, NEW, ONDEMAND, OUT,
    OVERRIDE, OWNED, PRIVATE, PROTECTED, PUBLIC, RANGE, REF, RETURN, SIGNAL, STATIC, STRUCT, THIS,
    UNOWNED, USING, VIRTUAL, WEAK, WHILE
}
...
const Keyword[] keywords = {
    ...
    { "static", Token.STATIC },
    { "struct", Token.STRUCT },
    { "AREALLYLONGBOGUSSTRINGTHATNOONESHOULDEVERFIND", Token.THIS },
